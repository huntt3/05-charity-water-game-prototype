...
// Optional: Only allow dragging if the user clicks on the ball
// (MouseConstraint will only pick up the ball if the mouse is over it)

// Comments for students:
// - We use Matter.js to handle all the physics (gravity, collisions, flippers)
// - The ball and flippers are Matter.js bodies
// - Flippers are rotated by setting their angular velocity when space is pressed
// - Constraints keep the flippers attached at one end
// - Walls keep the ball inside the play area
// - All rendering is handled by Matter.js
// - The MouseConstraint lets you drag the ball with your mouse.
// - You can click and hold the ball to move it around, then let go to release it.
// - This uses Matter.js's built-in mouse support for easy interaction.
